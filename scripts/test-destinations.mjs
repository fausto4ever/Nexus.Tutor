...
function createHarness(source){
  ...
  const defaults={version:'0.1.6',school:{name:'Escuela principal',lat:19,lng:-101},thresholds:{waitingMeters:1000,readyMeters:100,atGateMeters:20},distanceMode:'direct',refreshSeconds:30};
