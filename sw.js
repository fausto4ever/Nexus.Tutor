...
const ASSETS=['./','./index.html','./css/nexus-tutor.css','./config.js','./core/runtime.js','./services/location.js','./features/destinations.js','./features/journey.js','./ui/shell.js','./manifest.webmanifest','./icon.svg'];
